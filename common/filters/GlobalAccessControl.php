...
/**
 * GlobalAccessControl provides simple access control based on a set of rules.
 *
 * GlobalAccessControl is an action filter. It will check its [[rules]] to find
 ...
 *
 * To use GlobalAccessControl, declare it in the `behaviors()` method of your controller class.
 ...
 *     return [
 *         'access' => [
 *             'class' => \yii\filters\GlobalAccessControl::className(),
 *             'only' => ['create', 'update'],
 *             'rules' => [
 ...
 * @since 2.0
 */
class GlobalAccessControl extends ActionFilter
{
    /**
